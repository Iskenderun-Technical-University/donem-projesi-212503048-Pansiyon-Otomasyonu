    ...
    public partial class FrmYeniMusteri : Form
    {
       ...
       SqlConnection baglanti= new SqlConnection("Data Source=DESKTOP-20F8ATP;Initial Catalog=PansiyonOtomasyonu;Integrated Security=True");
        ...
        private void DtpCikisTarihi_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Çıkış Tarihi Giriş Tarihinden Önceki Günlerde Seçilemez");
            }
        }

        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(TxtAdi.Text) || string.IsNullOrEmpty(TxtSoyadi.Text) || string.IsNullOrEmpty(comboBox1.Text) || string.IsNullOrEmpty(MskTxtTelefon.Text) || string.IsNullOrEmpty(TxtMail.Text) || string.IsNullOrEmpty(TxtKimlikNo.Text) || string.IsNullOrEmpty(TxtOdaNo.Text) || string.IsNullOrEmpty(TxtUcret.Text) || string.IsNullOrEmpty(DtpGirisTarihi.Text) || string.IsNullOrEmpty(DtpCikisTarihi.Text))
            {
